...
class GameCategoryRow extends React.Component {
  ...
  round2Display() {
    ...
    let display = [
      <Card2Container
        question={this.state.round2Questions.easyQuestion}
        value={200}
        updateScore={this.props.updateScore}
        updateRound2Question={this.updateRound2Question}
      />,
      <Card2Container
        question={this.state.round2Questions.mediumQuestion}
        value={500}
        updateScore={this.props.updateScore}
        updateRound2Question={this.updateRound2Question}
      />,
      <Card2Container
        question={this.state.round2Questions.hardQuestion}
        value={1000}
        updateScore={this.props.updateScore}
        updateRound2Question={this.updateRound2Question}
      />
