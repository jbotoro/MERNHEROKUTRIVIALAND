...
class GameLobby extends React.Component {
    ...
    constructor(props) {
        ...
        // this.props.socket.on('room change', ({  }))
    }
    ...
    render() {
        ...
        if (!Object.keys(this.props.state.entities.game.length ) ) {
        ...
        let display = (this.props.game && this.props.currentUser.id === this.props.game.data.creator) ? 
        (<div>

            <div>
                <button onClick={this.props.handleStartButton}>Start Game</button>
            </div>
